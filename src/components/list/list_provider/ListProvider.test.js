...
it('should set correct addElements', async () => {
	...
	await expect(screen.getByText(/myElement/i)).toBeTruthy();
    await expect(screen.getByText(/mySecondElement/i)).toBeTruthy();
});
...
it('should set correct removeElement', async () => {
	...
	await expect(screen.queryByText(/myElement/i)).toBeTruthy();
    await expect(screen.queryByText(/mySecondElement/i)).toBeTruthy();
});
