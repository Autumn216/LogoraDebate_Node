...
describe("POST /embed/consultation", function() {
    let urlParams = '?shortname=logora-demo&id=18'

    describe("All parameters are valid", function() {
        it('should return a 200', function(done) { 
            chai.request(url)
                .post(`/embed/consultation${urlParams}`)
    ...
    describe("Parameter \"id\" is missing", function() {
        it('should return a 404', function(done) { 
            chai.request(url)
                .post(`/embed/consultation?shortname=logora-demo`)
                .set('content-type', 'application/json')
                .end(function(err, res) {
    ...
    describe("Data fetching error", function() {
        it('should return a 500', function(done) { 
            chai.request(url)
                .post(`/embed/consultation?shortname=logora-demo&id=500`)
                .set('content-type', 'application/json')
                .end(function(err, res) {
